...
class getFosRest_Serializer_FormErrorHandlerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['fos_rest.serializer.form_error_handler'] = new \FOS\RestBundle\Serializer\Normalizer\FormErrorHandler(($container->privates['fos_rest.serializer.form_error_handler.inner'] ?? ($container->privates['fos_rest.serializer.form_error_handler.inner'] = new \JMS\Serializer\Handler\FormErrorHandler(NULL, 'validators'))));
    }
}
