...
return [
    ...
    'api_app_logs_count' => [[], ['_controller' => 'App\\Controller\\LogsController::countLogs'], [], [['text', '/api/count']], [], [], []],
    'api_app_logs_delete' => [[], ['_controller' => 'App\\Controller\\LogsController::truncateLogs'], [], [['text', '/api/delete']], [], [], []],
    'app.swagger_ui' => [[], ['_controller' => 'nelmio_api_doc.controller.swagger_ui'], [], [['text', '/api/doc.json']], [], [], []],
];
