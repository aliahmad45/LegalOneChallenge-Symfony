...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\LogsController' => 'getLogsControllerService',
    ...
    /**
     * Gets the private '.1_Serializer~tFn5aae' shared service.
     *
     * @return \Symfony\Component\Serializer\Serializer
     */
    protected function get_1SerializertFn5aaeService()
    {
        return $this->privates['.1_Serializer~tFn5aae'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['property_info'] ?? $this->getPropertyInfoService()))], [0 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder()))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('czepzenkU2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('25LLAn2a2p', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K7jBCEH2F2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k4jGwTjrmL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9jWI2lkDo0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yLrbyhwGlG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Mf+Ul9nXXO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        $a = ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService());
        $b = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\OpenApi\Serializer\OpenApiNormalizer(($this->privates['.1_Serializer~tFn5aae'] ?? $this->get_1SerializertFn5aaeService())));
        ...
        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 2 => $b, 3 => $c, 4 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($d, [], $e), 5 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $e), 6 => $c, 7 => $b, 8 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $i, NULL, $d, ($this->privates['api_platform.subresource_operation_factory.cached'] ?? $this->getApiPlatform_SubresourceOperationFactory_CachedService()), $e), 9 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $j, $d), 10 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($d, true), 11 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 14 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $j, $i, $k, $a, $e, $l, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $m), 15 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $j, $i, $a, $e, $l, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $m), 16 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 17 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $e), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 24 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($k, $i, $j), 'page', 'pagination', $f, $a), $f, $i, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], [])))), 25 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 26 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($n, $j, $k), 27 => $n], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => ($this->privates['serializer.encoder.json'] ?? ($this->privates['serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder())), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
